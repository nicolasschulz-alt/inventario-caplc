...
return [
    ...
    | reglas tienen varias versiones, como las reglas de tamaño. Siéntete
    | libre de modificar estos mensajes según tus necesidades.
    |
    */
    ...
    | líneas. Esto hace que sea fácil especificar una línea de lenguaje
    | personalizada para una regla específica de un atributo.
    |
    */
    ...
    |----------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar el
    | marcador de posición de los atributos por algo más legible, como
