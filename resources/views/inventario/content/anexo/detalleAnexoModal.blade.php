        ...
        <table class="table mb-0 table-striped table-condensed">
            <tbody>
                <tr>
                    ...
                    <td class="text_black">{{$data->anexo_id}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="w-30 text-primary">Mac:</th>
                    <td class="text_black">
                ...
                <tr>
                    <th class="w-30 text-primary">Identificador:</th>
                    <td class="text_black">
                ...
                <tr>
                    <th class="w-30 text-primary">Categoria:</th>
                    <td class="text_black">{{$data->categoria_anexo ?? '--'}}</td>
                </tr>
                <tr>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
        <button onclick="editar_anexo({{$data->anexo_id}},1)" type="button" class="btn btn-outline-warning mt-3 btn-sm"><i class="fas fa-pen fa-sm"></i> Editar </button>
    </div>
  </div>