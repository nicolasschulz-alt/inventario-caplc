        ...
        <table class="table mb-0 table-striped table-condensed">
            <tbody>
                <tr>
                    ...
                    <td class="text_black">{{$data->monitor_id}}</td>
                </tr>
                <tr>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
        <button onclick="editar_monitor({{$data->monitor_id}},1)" type="button" class="btn btn-outline-warning mt-3 btn-sm"><i class="fas fa-pen fa-sm"></i> Editar </button>
    </div>
</div>