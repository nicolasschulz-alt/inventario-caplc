        ...
        <table class="table mb-0 table-striped table-condensed">
            <tbody>
                <tr>
                    ...
                    <td class="text_black">{{$data->impresora_id}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="w-30 text-primary">Conexión:</th>
                    <td class="text_black">
                        @if (isset($data->nombre_conexion) && !empty($data->nombre_conexion))
                ...
                <tr>
                    ...
                    <td class="text_black">{{$data->tipo_impresora ?? '--'}}</td>
                </tr>
                <tr>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
        <button onclick="editar_impresora({{$data->impresora_id}},1)" type="button" class="btn btn-outline-warning mt-3 btn-sm"><i class="fas fa-pen fa-sm"></i> Editar </button>
    </div>
  </div>