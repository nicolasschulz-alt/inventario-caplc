<style>
    #modal_editar_pc .form-group select,
    #modal_editar_pc .form-group option,
    #modal_editar_pc .form-group input,
    #modal_editar_pc .form-group textarea,
    #modal_editar_pc .form-group label
    {
        /* font-size: 14px; */
        color: #3a3b45;
    }
...
<form action="{{asset('/inventario/pc_editar')}}" id="form_editar_pc" route="{{ route('inventario.pc_update') }}" novalidate>
    @csrf
    <div class="row">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <select id="ip_id" name="ip_id" class="form-control {{ isset($data->ip_id) ? 'is-valid' : '' }}" name="state">
                    <option value=""></option>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control ipt_slc_value {{isset($data->nombre_equipo) ? 'is-valid' : ''}}" placeholder="" name="nombre_equipo" id="nombre_equipo" value="{{$data->nombre_equipo}}" autocomplete="off">
            </div>
        </div>
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                <label for="nombre_usuario_ad">Nombre de Usuario AD</label>
                <input type="text" class="form-control ipt_slc_value {{isset($data->nombre_usuario_ad) ? 'is-valid' : ''}}" name="nombre_usuario_ad" id="nombre_usuario_ad"   value="{{$data->nombre_usuario_ad}}" autocomplete="off" placeholder="">
            </div>
        </div>
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <select class="form-control {{ isset($data->cpu_id) ? 'is-valid' : '' }}" id="cpu_id" name="cpu_id">
                    <option value="" selected>Seleccionar</option>
                    @foreach ($cpu_pc as $item)
                        <option value="{{$item->id}}" {{isset($data->cpu_id) && $item->id == $data->cpu_id ? 'selected' : ''}}>{{$item->nombre}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <select class="form-control {{ isset($data->ram_id) ? 'is-valid' : '' }}" id="ram_id" name="ram_id">
                    <option value="" selected>Seleccionar</option>
                    @foreach ($ram_pc as $item)
                        <option value="{{$item->id}}" {{isset($data->ram_id) && $item->id == $data->ram_id ? 'selected' : ''}}>{{$item->nombre}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <select class="form-control {{ isset($data->disco_id) ? 'is-valid' : '' }}" id="disco_id" name="disco_id">
                    <option value="" selected>Seleccionar</option>
                    @foreach ($disco_pc as $item)
                        <option value="{{$item->id}}" {{isset($data->disco_id) && $item->id == $data->disco_id ? 'selected' : ''}}>{{$item->nombre_disco}} ({{$item->nombre_tipo_disco}})</option>
                    @endforeach
                </select>
            </div>
        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td scope="row" nowrap width="50%">
                                                    <select class="form-control {{isset($data->sistema_operativo) ? 'is-valid' : ''}}" id="so_id" name="so_id">
                                                        <option value="" selected>Seleccionar</option>
                                                        @foreach ($sistema_operativo as $item)
                                                            <option value="{{$item->id}}" {{isset($data->sistema_operativo) && $item->id == $data->sistema_operativo->id ? 'selected' : ''}}>{{$item->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td nowrap>
                                                    <div class="form-group no-margen-bottom">
                                                        <select class="form-control ancho-wbk-fill-av {{isset($data->sistema_operativo) ? 'is-valid' : ''}}" id="slc_apl_lic_so" >
                                                            <option value="" selected hidden>--</option>
                                                            <option value="1" {{isset($data->sistema_operativo) && $data->sistema_operativo->tiene_licencia == 1 ? 'selected' : ''}}>Con licencia</option>
                                                            <option value="0" {{isset($data->sistema_operativo) && $data->sistema_operativo->tiene_licencia == 0 ? 'selected' : ''}}>Sin licencia</option>
                                                            <option value="2" {{isset($data->sistema_operativo) && $data->sistema_operativo->tiene_licencia == 2 ? 'selected' : ''}}>No aplica</option>
                                                        </select>
                                                    </div>
                                                </td>
                                                <td nowrap>
                                                    <input type="text" class="form-control ancho-wbk-fill-av {{isset($data->sistema_operativo) && isset($data->sistema_operativo->licencia) ? 'is-valid' : ''}}" id="licencia_so" value="{{isset($data->sistema_operativo) && isset($data->sistema_operativo->licencia) ? $data->sistema_operativo->licencia : ''}}" placeholder="--" autocomplete="off">
                                                </td>
                                            </tr>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td scope="row" nowrap width="50%">
                                                    <select class="form-control {{isset($data->office) ? 'is-valid' : ''}}" id="office_id" name="office_id">
                                                        <option value="" selected>Seleccionar</option>
                                                        @foreach ($office as $item)
                                                            <option value="{{$item->id}}" {{isset($data->office) && $item->id == $data->office->id ? 'selected' : ''}}>{{$item->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td nowrap>
                                                    <div class="form-group no-margen-bottom">
                                                        <select class="form-control ancho-wbk-fill-av {{isset($data->office) ? 'is-valid' : ''}}" id="slc_apl_lic_office" >
                                                            <option value="" selected hidden>--</option>
                                                            <option value="1" {{isset($data->office) && $data->office->tiene_licencia == 1 ? 'selected' : ''}}>Con licencia</option>
                                                            <option value="0" {{isset($data->office) && $data->office->tiene_licencia == 0 ? 'selected' : ''}}>Sin licencia</option>
                                                            <option value="2" {{isset($data->office) && $data->office->tiene_licencia == 2 ? 'selected' : ''}}>No aplica</option>
                                                        </select>
                                                    </div>
                                                </td>
                                                <td nowrap>
                                                    <input type="text" class="form-control ancho-wbk-fill-av {{isset($data->office) && isset($data->office->licencia) ? 'is-valid' : ''}}" id="licencia_office" value="{{isset($data->office) && isset($data->office->licencia) ? $data->office->licencia : ''}}" placeholder="--" autocomplete="off">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td scope="row" nowrap width="50%">
                                                    <select class="form-control {{isset($data->antivirus) ? 'is-valid' : ''}}" id="antivirus_id" name="antivirus_id">
                                                        <option value="" selected>Seleccionar</option>
                                                        @foreach ($antivirus as $item)
                                                            <option value="{{$item->id}}" {{isset($data->antivirus) && $item->id == $data->antivirus->id ? 'selected' : ''}}>{{$item->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td nowrap>
                                                    <div class="form-group no-margen-bottom">
                                                        <select class="form-control ancho-wbk-fill-av {{isset($data->antivirus) ? 'is-valid' : ''}}" id="slc_apl_lic_antivirus" >
                                                            <option value="" selected hidden>--</option>
                                                            <option value="1" {{isset($data->antivirus) && $data->antivirus->tiene_licencia == 1 ? 'selected' : ''}}>Con licencia</option>
                                                            <option value="0" {{isset($data->antivirus) && $data->antivirus->tiene_licencia == 0 ? 'selected' : ''}}>Sin licencia</option>
                                                            <option value="2" {{isset($data->antivirus) && $data->antivirus->tiene_licencia == 2 ? 'selected' : ''}}>No aplica</option>
                                                        </select>
                                                    </div>
                                                </td>
                                                <td nowrap>
                                                    <input type="text" class="form-control ancho-wbk-fill-av {{isset($data->antivirus) && isset($data->antivirus->licencia) ? 'is-valid' : ''}}" id="licencia_antivirus" value="{{isset($data->antivirus) && isset($data->antivirus->licencia) ? $data->antivirus->licencia : ''}}" placeholder="--" autocomplete="off">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table id="apps" class="table table-bordered table-hover">
                                        ...
                                        @foreach ($app_ecritorio as $item)
                                            ...
                                            @if (isset($data->app_ecritorio))
                                                @foreach ($data->app_ecritorio as $item_data)
                                                    @if ($item->id == $item_data->id)
                                                        @php 
                                                            $check = true; 
                                                            $tiene_licencia = $item_data->tiene_licencia;
                                                            $licencia = $item_data->licencia;
                                                        @endphp
                                                    @endif
                                                @endforeach
                                            @endif
                                            <tr>
                                                <th scope="row" nowrap>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="{{$item->id}}" id="input_check_app_{{$item->id}}" {{$check == true ? 'checked' : ''}}>
                                                        <label class="lbl-chck form-check-label {{$check == true ? 'lbl-chck-active' : ''}}" for="input_check_app_{{$item->id}}">
                                                            {{$item->nombre}}
                                                        </label>
                                                    </div>
                                                </th>
                                                <td nowrap>
                                                    <div class="form-group no-margen-bottom">
                                                        <select class="form-control ancho-wbk-fill-av {{$check == true ? 'is-valid' : ''}}" id="slc_apl_lic_app_{{$item->id}}" >
                                                            <option value="" selected hidden>--</option>
                                                            <option value="1" {{$tiene_licencia == 1 ? 'selected' : ''}}>Con licencia</option>
                                                            <option value="0" {{$tiene_licencia == 0 ? 'selected' : ''}}>Sin licencia</option>
                                                            <option value="2" {{$tiene_licencia == 2 ? 'selected' : ''}}>No aplica</option>
                                                        </select>
                                                    </div>
                                                </td>
                                                <td nowrap>
                                                    <input type="text" class="form-control ancho-wbk-fill-av {{isset($licencia) && !empty($licencia) ? 'is-valid' : ''}}" id="licencia_app_{{$item->id}}" value="{{isset($licencia) ? $licencia : ''}}" placeholder="--" autocomplete="off" {{$tiene_licencia == 1 ? '' : 'disabled'}}>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
        ...
        {{-- <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <input type="text" placeholder="" class="form-control ipt_slc_value {{isset($data->correo) ? 'is-valid' : ''}}" id="correo" name="correo" value="{{isset($data->correo) ? $data->correo : ''}}" autocomplete="off">
            </div>
        </div> --}}
        {{-- <div class="col-md-4 col-sm-12">
            <div class="form-group">
                <label for="telefono_id">Teléfono</label>
                <select class="form-control {{isset($data->telefono_id) ? 'is-valid' : ''}}" id="telefono_id" name="telefono_id">
                    <option value=""></option>
                    @foreach ($anexo as $item)
                        <option value="{{$item->id}}" {{isset($data->telefono_id) && $item->id == $data->telefono_id ? 'selected' : ''}}>{{$item->anexo}}</option>
                    @endforeach
                </select>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <select class="form-control {{isset($data->oc_id) ? 'is-valid' : ''}}" id="oc_id" name="oc_id">
                    <option value="" selected>Seleccionar</option>
                    @foreach ($orden_compra as $item)
                        <option value="{{$item->id}}" {{isset($data->oc_id) && $item->id == $data->oc_id ? 'selected' : ''}}>{{$item->descripcion}}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <button type="button" id="btn_editar_form_pc" route="{{ route('inventario.pc_update') }}" class="btn btn-warning btn-md">Editar</button>
            <input type="hidden" id="pc_id_editar" name="pc_id_editar" value="{{$pc_id}}">
        </div>
    </div>
</form>

<script>
    var cerrar_modal_edit_pc = false;
    $(document).ready(function () {

        //bloquea campos iniciales form registro PC
        //bloqueaCamposFormRegistrarPC();

        $('#modal_editar_pc .close').on('click', function (event) {
           console.log(event);
           event.preventDefault(); // Previene el cierre del modal
           event.stopPropagation(); // Detiene la propagación del evento

           if (!cerrar_modal_edit_pc){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        cerrar_modal_edit_pc = true;
                        $('#modal_editar_pc').modal('hide');
                        console.log('confirma salir');
                        
                    } else {
                        cerrar_modal_edit_pc = false;
                    }
                });
           }
        ...
        $('#modal_editar_pc').on('hidden.bs.modal', function (event) {
            console.log('El modal editar ha sido cerrado.');
            $('#body_modal_editar_pc').html('');
        });
        ...
        $('#btn_editar_form_pc').on('click', function (event) {
            event.preventDefault();
            ...
            const objeto_data = {
                ...
                pc_id : document.getElementById('pc_id_editar').value,
    ...
    /* function //bloqueaCamposFormRegistrarPC(){
        ...
        $('#form_editar_pc input').prop('disabled',true);
        $('#form_editar_pc select').prop('disabled',true);
        $('#form_editar_pc textarea').prop('disabled',true);
        $('#form_editar_pc button').prop('disabled',true);
        $('#form_editar_pc #serie').prop('disabled',false);
        //$('#btn_comprobar_serie_pc').prop('disabled',false);
        $('#btn_cambiar_serie_pc').prop('disabled',false);
        
    } */
   /*   function  ActivaCamposFormRegistrarPC (){

        //await new Promise(resolve => setTimeout(resolve, 500));
        //await new Promise(resolve => (resolve));

        $('#form_editar_pc input').prop('disabled',false);
        $('#form_editar_pc select').prop('disabled',false);
        $('#form_editar_pc textarea').prop('disabled',false);
        $('#form_editar_pc button').prop('disabled',false);
        $('#numero_sala').prop('disabled',true);
        $('#nombre_sala').prop('disabled',true);
        $('#serie').prop('disabled',true);

    } */
    /* function //bloqueaCamposAppsFormRegistrarPc(){

        //await new Promise(resolve => (resolve));

        $('#form_editar_pc #slc_apl_lic_so').prop('disabled',true);
        $('#form_editar_pc #slc_apl_lic_office').prop('disabled',true);
        $('#form_editar_pc #slc_apl_lic_antivirus').prop('disabled',true);
        $('#form_editar_pc select[id^=slc_apl_lic_app_]').prop('disabled',true);
        $('#form_editar_pc input[id^=licencia_app_]').prop('disabled',true);
