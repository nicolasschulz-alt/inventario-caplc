...
<body {{-- class="container" --}} id="page-top">
    ...
    <div class="loader-container-caplc loader-hide-caplc">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{asset('/tic')}}">
                <div class="sidebar-brand-icon {{-- rotate-n-1 --}}5">
    ...
    <script>
        /* function loader(param = null){
            console.log(param);
            if (param == 'show') {
                document.body.classList.add('loader-caplc'); // Añade la clase global
            } else if (param == 'hide') {
                document.body.classList.remove('loader-caplc'); // Elimina la clase global
            }
        } */
        function loader(param = null){
            console.log(param);
            if (param == 'show') {
                $('.loader-container-caplc').removeClass('loader-hide-caplc').addClass('loader-show-caplc');
               
            } else if (param == 'hide') {
                $('.loader-container-caplc').removeClass('loader-show-caplc').addClass('loader-hide-caplc');
            }
        }
